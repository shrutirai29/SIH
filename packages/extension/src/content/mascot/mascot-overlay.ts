  ...
  private getStyles(): string {
    return `
      <style>
        ...
        /* Conversational Q&A Card in HUD */
        .hud-question-card {
          background: rgba(30, 58, 138, 0.45) !important;
          border: 1.5px solid rgba(59, 130, 246, 0.7) !important;
          border-radius: 6px;
          padding: 10px 12px;
          display: flex;
          flex-direction: column;
